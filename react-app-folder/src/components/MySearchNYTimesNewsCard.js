...
class MySearchNYTimesNewsCard extends React.Component {
    constructor(props)
    {
    ...
    {    
        ...
        var newsTag
        if(this.props.newsCard.news_desk.toLowerCase()=="world")
        {
            newsTag=<Badge variant="primary" style={{backgroundColor:"rgb(128, 24, 212)", marginRight:"0px"}}>WORLD</Badge>
        }
        else if(this.props.newsCard.news_desk.toLowerCase()=="politics")
        {
            newsTag=<Badge variant="success" style={{backgroundColor:"rgb(7, 102, 43)",textAlign:"right"}}>POLITICS</Badge>
        }
        else if(this.props.newsCard.news_desk.toLowerCase()=="business")
        {
            newsTag=<Badge variant="info">BUSINESS</Badge>
        }
        else if(this.props.newsCard.news_desk.toLowerCase()=="technology")
        {
            newsTag=<Badge variant="warning" style={{backgroundColor:"rgb(218, 247, 90)"}}>TECHNOLOGY</Badge>
        }
        else if(this.props.newsCard.news_desk.toLowerCase()=="sports")
        {
            newsTag=<Badge variant="warning">SPORTS</Badge>
        }
        else
        {
            newsTag=<Badge variant="secondary">{this.props.newsCard.news_desk.toUpperCase()}</Badge>
        }
        ...
        let detailedLink='https://api.nytimes.com/svc/search/v2/articlesearch.json?fq=web_url:("'+this.props.newsCard.web_url+'")&api-key=DXNhYbJijwtz5G7wE8vTnLSuljXZPOFk';
        
        return(
            <Col xs="12" sm="12" md="3" lg="3" xl="3">
            <Link style={{textDecoration:"none", color:"black"}} to={{
                pathname:'/article',
                search:'?id='+this.props.newsCard.web_url,
                newsCardInfo:{
                        ...
                        <Row>
                            <Col  xs="12" sm="12" md="12" lg="12" xl="12">
                                ...
                                <Truncate width={375} ellipsis={<span>...</span>}>
                                    {this.props.newsCard.headline.main}
                                </Truncate>
                                ...
                                <Modal show={this.state.show} onHide={this.handleClose}>
                                    ...
                                    <Modal.Title>{this.props.newsCard.headline.main}</Modal.Title>
                                    </Modal.Header>
                                    <Modal.Body>
                                        <p style={{textAlign:"center"}}>Share via</p>
                                        <div style={{textAlign:"center"}}>  
                                            <FacebookShareButton style={{marginRight:"10px"}} url={this.props.newsCard.web_url} hashtag="#CSCI_571_NewsApp">
                                                <FacebookIcon size={32} round={true}/>
                                            </FacebookShareButton>
                                            <TwitterShareButton style={{marginRight:"10px"}} url={this.props.newsCard.web_url} hashtags={["CSCI_571_NewsApp"]}>
                                                <TwitterIcon size={32} round={true}/>
                                            </TwitterShareButton>
                                            <EmailShareButton url={this.props.newsCard.web_url} subject="#CSCI_571_NewsApp">
                                ...
                                <Row>
                                    ...
                                    <p>
                                        {
                                            this.props.newsCard.pub_date.slice(0,this.props.newsCard.pub_date.indexOf("T"))
...
export default MySearchNYTimesNewsCard